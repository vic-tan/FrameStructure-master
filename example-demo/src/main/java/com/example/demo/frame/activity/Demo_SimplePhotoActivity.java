...
public class Demo_SimplePhotoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new PhotoBean("http://h.hiphotos.baidu.com/image/pic/item/574e9258d109b3dedb168a8ec8bf6c81810a4cae.jpg", "http://h.hiphotos.baidu.com/image/pic/item/574e9258d109b3dedb168a8ec8bf6c81810a4cae.jpg", 0));
        list.add(new PhotoBean("http://e.hiphotos.baidu.com/image/pic/item/e61190ef76c6a7ef726b5320fffaaf51f3de6663.jpg", "http://e.hiphotos.baidu.com/image/pic/item/e61190ef76c6a7ef726b5320fffaaf51f3de6663.jpg", 0));
        list.add(new PhotoBean("http://img5.duitang.com/uploads/item/201407/30/20140730152939_zPFKy.thumb.700_0.jpeg", "http://a.hiphotos.baidu.com/image/pic/item/bf096b63f6246b60fc49d17ce9f81a4c510fa277.jpg", 0));
        list.add(new PhotoBean("http://a.hiphotos.baidu.com/image/pic/item/8435e5dde71190ef1ef587d5cc1b9d16fdfa60a9.jpg", "http://a.hiphotos.baidu.com/image/pic/item/8435e5dde71190ef1ef587d5cc1b9d16fdfa60a9.jpg", 0));
        list.add(new PhotoBean("http://a.hiphotos.baidu.com/image/pic/item/8435e5dde71190ef1ef587d5cc1b9d16fdfa60a9.jpg", "http://g.hiphotos.baidu.com/image/pic/item/adaf2edda3cc7cd9c38927a23c01213fb80e9120.jpg", 0));
        list.add(new PhotoBean("http://f.hiphotos.baidu.com/image/pic/item/7acb0a46f21fbe09def7781469600c338744ad01.jpg", "http://f.hiphotos.baidu.com/image/pic/item/7acb0a46f21fbe09def7781469600c338744ad01.jpg", 0));
        ...
        list.add(new PhotoBean("http://images.99pet.com/InfoImages/wm600_450/1d770941f8d44c6e85ba4c0eb736ef69.jpg", "http://ww2.sinaimg.cn/mw600/c6c1d258jw1e5r59ttpkcj20gu0gsmyh.jpg", 0));
        list.add(new PhotoBean("http://a.hiphotos.baidu.com/image/pic/item/7e3e6709c93d70cfbbdea204fadcd100baa12b96.jpg", "http://a.hiphotos.baidu.com/image/pic/item/7e3e6709c93d70cfbbdea204fadcd100baa12b96.jpg", 0));
        list.add(new PhotoBean("http://f.hiphotos.baidu.com/image/pic/item/8644ebf81a4c510fa42d1bf66459252dd52aa575.jpg", "http://f.hiphotos.baidu.com/image/pic/item/8644ebf81a4c510fa42d1bf66459252dd52aa575.jpg", 0));
        list.add(new PhotoBean("http://d.hiphotos.baidu.com/image/pic/item/caef76094b36acaffd0002e37ed98d1000e99cc9.jpg", "http://d.hiphotos.baidu.com/image/pic/item/caef76094b36acaffd0002e37ed98d1000e99cc9.jpg", 0));
    ...
    private class ImagesInnerGridViewAdapter extends BaseAdapter {
        ...
        public ImagesInnerGridViewAdapter(List<PhotoBean> datas) {
            this.datas = datas;
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final PhotoBean bean = getBean(position);
            final SquareCenterImageView imageView = new SquareCenterImageView(Demo_SimplePhotoActivity.this);
            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
            imageView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //Intent intent = new Intent(Demo_SimplePhotoActivity.this, BaseSmoothPhotoViewActivity.class);
                    Intent intent = new Intent(Demo_SimplePhotoActivity.this, Demo_SmoothPagerPhotoViewActivity.class);
                   // Intent intent = new Intent(Demo_SimplePhotoActivity.this, Demo_SpaceImageDetailActivity.class);
        ...
        public PhotoBean getBean(int pos) {
            return (PhotoBean) datas.get(pos);
        }

...
public class DemoHttpTaskActivity extends BaseActivity implements View.OnClickListener, IHttpTaskCallBack, IRefreshRequestCallBack {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_1_1) {//步骤
            ...
            HttpTask.post(new RequestBean(this, BaseHttpParams.baseParams(UrlConstants.TEST_LIST)), new IHttpTaskCallBack() {
                ...
                public void taskCallBack(RequestBean requestBean) {
                    switch (requestBean.getRequestLevel()) {
                        case START:
                            ToastUtils.show(DemoHttpTaskActivity.this, "PROGRESS");
                            break;
                        case SUCCESS:
                            if (null != requestBean.getBaseJson()) {
                                ToastUtils.show(DemoHttpTaskActivity.this, requestBean.getBaseJson().getData());
                            }
                            break;
                        case FAILURE:
                            ToastUtils.show(DemoHttpTaskActivity.this, "INTERRUPT");
                            break;
                        case FINISH:
                            ToastUtils.show(DemoHttpTaskActivity.this, "FINISH");
                            break;
                        case TIMEOUT_ERROR:
                            ToastUtils.show(DemoHttpTaskActivity.this, "TIMEOUT_ERROR");
                            break;
                        case SERVICE_ERROR:
                            ToastUtils.show(DemoHttpTaskActivity.this, "SERVICE_ERROR");
                            break;
                        case NETWORK_ERROR:
                            ToastUtils.show(DemoHttpTaskActivity.this, "BaseApplication.getContext()");
                            break;
            ...
            StartActUtils.start(this, DemoListViewActivity.class);

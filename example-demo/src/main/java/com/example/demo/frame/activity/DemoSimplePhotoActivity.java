...
public class DemoSimplePhotoActivity extends BaseActivity {
    ...
    private class ImagesInnerGridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final SquareCenterImageView imageView = new SquareCenterImageView(DemoSimplePhotoActivity.this);
            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
            imageView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //Intent intent = new Intent(DemoSimplePhotoActivity.this, BaseSmoothPhotoViewActivity.class);
                    Intent intent = new Intent(DemoSimplePhotoActivity.this, DemoSmoothPagerPhotoViewActivity.class);
                   // Intent intent = new Intent(DemoSimplePhotoActivity.this, DemoSpaceImageDetailActivity.class);

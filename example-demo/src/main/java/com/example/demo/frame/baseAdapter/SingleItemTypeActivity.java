...
import com.example.demo.frame.baseAdapter.bean.Bean;
 ...
 */
public class SingleItemTypeActivity extends ListActivity {
            ...
            public void convert(final ViewHolder holder, final Bean bean) {
                ...
                holder.setOnClickListener(R.id.id_title, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Toast.makeText(SingleItemTypeActivity.this, bean.getTitle(), Toast.LENGTH_SHORT).show();
                    }
                });
            }

...
public class Demo_BasePhotoActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void B(View v) {
        StartActUtils.start(this, Demo_PagerPhotoActivity.class, "list", (Serializable) list);
    }

    public void C(View v) {
        StartActUtils.start(this, Demo_SimplePhotoActivity.class);
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.img_test) {
            Intent intent = new Intent(Demo_BasePhotoActivity.this, Demo_SpaceImageDetailActivity.class);

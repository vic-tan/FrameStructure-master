...
public class DataSupportException extends RuntimeException {
	 ...
	 */
	public static final String MODEL_Ip_NOT_AN_INSTANCE_OF_DATA_SUPPORT = " should be inherited from DataSupport";
	 ...
	 */
	public static final String UPDATE_CONDITIONp_EXCEPTION = "The parameters in conditions are incorrect.";

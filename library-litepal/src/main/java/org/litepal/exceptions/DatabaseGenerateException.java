...
public class DatabaseGenerateException extends RuntimeException {
	 ...
	 */
	public static final String CLASp_NOT_FOUND = "can not find a class named ";
	 ...
	 */
	public static final String TABLE_DOEp_NOT_EXIST_WHEN_EXECUTING = "Table doesn't exist when executing ";

	/**
	 * Can not find a table with the passing table name.
	 */
	public static final String TABLE_DOEp_NOT_EXIST = "Table doesn't exist with the name of ";

...
public final class AnimatorSet extends Animator {
     ...
     * common_cancel or end when common_cancel() or end() is called on this AnimatorSet
     */
     ...
     * terminated (by calling common_cancel() or end()).
     * This flag is used to avoid starting other animations when currently-playing
     * child animations of this AnimatorSet end. It also determines whether common_cancel/end
    ...
    public void cancel() {
        ...
        if (isStarted()) {
            ...
            if (mDelayAnim != null && mDelayAnim.isRunning()) {
                // If we're currently in the startDelay period, just common_cancel that animator and
    ...
    private static class DependencyListener implements AnimatorListener {
        ...
        /**
         * Ignore common_cancel events for now. We may want to handle this eventually,
    ...
    private class AnimatorSetListener implements AnimatorListener {
        ...
        public void onAnimationCancel(Animator animation) {
            if (!mTerminated) {
                // Listeners are already notified of the AnimatorSet canceling in common_cancel().
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            animNode.done = true;
            if (!mTerminated) {
                // Listeners are already notified of the AnimatorSet ending in common_cancel() or

...
public class ValueAnimator extends Animator {
     ...
     * has been common_cancel()'d or end()'d since the last animation frame. Possible values are
    ...
    @Override
    public void cancel() {
        // Only common_cancel if the animation is actually running or has been started and is about
        // to run

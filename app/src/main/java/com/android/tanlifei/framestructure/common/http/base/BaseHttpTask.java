 ...
 * <li>{@link #setAsyncHttpResponseHandler(ReqBean, int, IHttpTaskCallBack)}  response响应回调</li>
...
public class BaseHttpTask {
     ...
     * @return
     */
    protected static AsyncHttpResponseHandler setAsyncHttpResponseHandler(final ReqBean params, final int callBackTag, final IHttpTaskCallBack callBackMethod) {

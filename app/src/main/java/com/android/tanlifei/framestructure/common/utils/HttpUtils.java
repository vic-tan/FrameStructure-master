 ...
 * <li>{@link #get(TaskParamsBean, AsyncHttpResponseHandler)}  get 请求 以普通形式提交参数</li>
 * <li>{@link #getJsonParams(TaskParamsBean, AsyncHttpResponseHandler)}  get 请求 以json格式提交参数</li>
 * <li>{@link #post(TaskParamsBean, AsyncHttpResponseHandler)}  post 请求，以普通形式提交参数</li>
 * <li>{@link #postJsonParams(TaskParamsBean, AsyncHttpResponseHandler)} post 请求，以json格式提交参数</li>
...
public class HttpUtils {
     ...
     */
    public static void get(TaskParamsBean params,
     ...
     * @param res    AsyncHttpResponseHandler 获取 byte[]数组字节
     */
    public static void getJsonParams(TaskParamsBean params,
                                     AsyncHttpResponseHandler res) {
     ...
     * @param res    AsyncHttpResponseHandler 获取 byte[]数组字节
     */
    public static void post(TaskParamsBean params, AsyncHttpResponseHandler res) {
     ...
     * @param res    AsyncHttpResponseHandler 获取 byte[]数组字节
     */
    public static void postJsonParams(TaskParamsBean params,
                                      AsyncHttpResponseHandler res) {

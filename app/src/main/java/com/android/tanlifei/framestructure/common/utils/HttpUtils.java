 ...
 * <li>{@link #get(ReqBean, AsyncHttpResponseHandler)}  get 请求 以普通形式提交参数</li>
 * <li>{@link #getJsonParams(ReqBean, AsyncHttpResponseHandler)}  get 请求 以json格式提交参数</li>
 * <li>{@link #post(ReqBean, AsyncHttpResponseHandler)}  post 请求，以普通形式提交参数</li>
 * <li>{@link #postJsonParams(ReqBean, AsyncHttpResponseHandler)} post 请求，以json格式提交参数</li>
...
public class HttpUtils {
     ...
     */
    public static void get(ReqBean params,
     ...
     * @param res    AsyncHttpResponseHandler 获取 byte[]数组字节
     */
    public static void getJsonParams(ReqBean params,
                                     AsyncHttpResponseHandler res) {
     ...
     * @param res    AsyncHttpResponseHandler 获取 byte[]数组字节
     */
    public static void post(ReqBean params, AsyncHttpResponseHandler res) {
     ...
     * @param res    AsyncHttpResponseHandler 获取 byte[]数组字节
     */
    public static void postJsonParams(ReqBean params,
                                      AsyncHttpResponseHandler res) {

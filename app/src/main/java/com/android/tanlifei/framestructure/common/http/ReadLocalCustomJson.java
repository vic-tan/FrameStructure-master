 ...
 * <li>{@link #readJson(ReqBean, IHttpTaskCallBack, int)}   读取本地自定义Json测试数据</li>
...
public class ReadLocalCustomJson extends BaseHttpTask {
     ...
     * @param callBackTag
     */
    public static void readJson(final ReqBean params, final IHttpTaskCallBack callBackMethod, final int callBackTag) {

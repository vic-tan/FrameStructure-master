 ...
 * <li>{@link #LayoutHttpTask(Context, ILayoutReStartCallBack, View)} 默认弹出正在加载提示框</li>
 * </ul>
 *
 * @author tanlifei
...
public class LayoutHttpTask extends TaskController {
     ...
     * @param context
     */
    public LayoutHttpTask(Context context, ILayoutReStartCallBack backCall, View view) {

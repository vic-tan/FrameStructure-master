...
public class PullToRefreshWebView2 extends PullToRefreshWebView {
	...
	static final String Jp_INTERFACE_PKG = "ptr";
	static final String DEF_Jp_READY_PULL_DOWN_CALL = "javascript:isReadyForPullDown();";
	static final String DEF_Jp_READY_PULL_UP_CALL = "javascript:isReadyForPullUp();";
	...
	protected WebView createRefreshableView(Context context, AttributeSet attrs) {
		...
		webView.addJavascriptInterface(mJsCallback, Jp_INTERFACE_PKG);
	...
	protected boolean isReadyForPullStart() {
		// Call Javascript...
		getRefreshableView().loadUrl(DEF_Jp_READY_PULL_DOWN_CALL);
	...
	protected boolean isReadyForPullEnd() {
		// Call Javascript...
		getRefreshableView().loadUrl(DEF_Jp_READY_PULL_UP_CALL);
